...
$products = [
    [
        "id" => "11", //код товара (из каталога CRM)
        "name" => "Набор 208in", //название товара
        "price" => "349000", //цена товара 1
...
$subject2    = "Набор 58 349,000 [заказ обратной связи с сайта]"; // ----------------------------------------- заголовок
$message2    = "
<br>Имя: ".$_POST['name']."
